  ...
  return (
    <main className="flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-4 my-1">
        <GraficoLineal Title="Total Ventas / Compras" SubTitle="Subtitulo de la grafica"/>
        <GraficoLineal Title="Cantidad Operaciones de Venta" Info="Informacion de la grafica" />
        <GraficoLineal Title="Cantidad Operaciones de Compra" Period="Periodos definidos en la grafica"  />
      </div>
    </main>
  );
}

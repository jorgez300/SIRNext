          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-[50px] text-center">Existencia</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody className="">
              {data.map((item) => (
                ...
                >
                  <TableCell className="w-[100px] text-center">{item.Codigo}</TableCell>
                  <TableCell>{item.Descripcion}</TableCell>
                  <TableCell className="w-[50px] text-center">{item.Existencia}</TableCell>
                </TableRow>
              ))}
